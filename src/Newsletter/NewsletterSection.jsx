...
import newsletterImage from "../assets/newslettersvg.svg";

function CtaSection() {
  return (
    <section className="cta__section max-w-5xl mx-auto py-14 px-5 lg:px-0">
      <div
        className=" bg-[#295D4E] p-10 rounded-2xl
